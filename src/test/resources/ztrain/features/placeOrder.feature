...
Feature: Place an order
  ...
  Background:
    ...
    * def req = read ('classpath:ztrain/data/registerUser.Json')
    ...
    * def reqNewP = read ('classpath:ztrain/data/createNewProduct.json')
    ...
    * def reqAdd2cart = read ('classpath:ztrain/data/add2cart.json')
    ...
    * def reqAdd2Favoris = read ('classpath:ztrain/data/add2Favorite.json')
    ...
    * def reqPlaceOrder = read ('classpath:ztrain/data/submitOrder.json')
